...
public class GithubSteps {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GithubSteps.class);

    @Step("call API get list repositories of {0}")
    public void getRepositories(String orgName) {
        // Get base url from serenity.conf
    ...
    public void printResult() {
        logger.info("Number of repository: " + repositories.size());
    }
}
